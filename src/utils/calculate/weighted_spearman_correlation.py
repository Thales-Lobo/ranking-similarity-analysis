...
def weighted_spearman_correlation(list1: List[int],
                                    list2: List[int],
                                    weights: List[float],
                                    linear_scale_factor: float = 2.5,
                                    exponencial_scale_factor: float = 2.0) -> float:
    """
    ...
    - linear_scale_factor (float): Factor to scale the numerator of the correlation calculation. 
                                   Default is 2.5.
    - exponencial_scale_factor (float): Factor to scale the numerator of the correlation calculation. 
                                        Default is 2.0.
    ...
    numerator = 6 * weighted_sum_d_squared * linear_scale_factor
    denominator = n * (n ** 2 - 1)
    
    correlation = 1 - (numerator / denominator)  ** (1 / exponencial_scale_factor)
    return correlation
